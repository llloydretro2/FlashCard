...
def _readmodule(module, path, inpackage=None):
    ...
    if spec is None:
        raise ModuleNotFoundError(f"no module named {fullmodule!r}",
                                  name=fullmodule)
...
def _main():
    ...
    while objs:
        ...
        if isinstance(obj, Class):
            print("{}class {} {} {}".format(' ' * obj.indent, obj.name,
