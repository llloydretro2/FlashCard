...
__all__ = [
    ...
    "month_name", "month_abbr", "day_name", "day_abbr", "Calendar",
    "TextCalendar", "HTMLCalendar", "LocaleTextCalendar", "LocaleHTMLCalendar",
    "weekheader"
]
...
def leapdays(y1, y2):
    ...
    y1 -= 1
    y2 -= 1
    return (y2 // 4 - y1 // 4) - (y2 // 100 - y1 // 100) + (y2 // 400 -
                                                            y1 // 400)
...
class HTMLCalendar(Calendar):
    ...
    def formatweekday(self, day):
        ...
        """
        return '<th class="%s">%s</th>' % (self.cssclasses_weekday_head[day],
                                           day_abbr[day])
