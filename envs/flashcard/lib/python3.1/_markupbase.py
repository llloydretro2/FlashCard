...
class ParserBase:
    ...
    def parse_declaration(self, i):
        ...
        while j < n:
            ...
            if c in "\"'":
                ...
                raise AssertionError("unexpected %r char in declaration" %
                                     rawdata[j])
            if j < 0:
                return j
        return -1  # incomplete
    ...
    def _parse_doctype_subset(self, i, declstartpos):
        ...
        while j < n:
            ...
            if c == "<":
                ...
                self.updatepos(declstartpos, j)
                raise AssertionError("unexpected char %r in internal subset" %
                                     c)
    ...
    def _scan_name(self, i, declstartpos):
        ...
        if m:
            ...
            raise AssertionError("expected name token at %r" %
